...
function legacyBookSections(data: Record<string, any>): PortfolioSection[] {
  ...
  return [
    ...
    { id: "research", title: "Research", slug: "research", intro: "Questions I am currently interested in exploring.", visible: true, order: 4, builtIn: true, entries: [makeEntry("research-interests", "Human-centred intelligent systems", "Current interests", "I am interested in systems that make complex decisions more understandable, reliable, and useful to the people who depend on them.", ["AI", "Safety", "Accessibility"])] },
